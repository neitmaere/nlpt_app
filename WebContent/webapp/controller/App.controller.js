  ...
  return Controller.extend("com.nlpt.app.controller.App", {
    ...
    onMaintainGamerPress : function(fragment) {
      ...
      if (!this._gamerEditDialog) {
        ...
        this._gamerEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.GamerEditDialog", this);
    ...
    onMaintainShooterPress : function() {
      ...
      if (!this._shooterEditDialog) {
        // create dialog via fragment factory
        this._shooterEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.ShooterEditDialog", this);
        // connect dialog to view (models, lifecycle)
    ...
    onMaintainSportPress : function() {
      ...
      if (!this._sportEditDialog) {
        // create dialog via fragment factory
        this._sportEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.SportEditDialog", this);
        // connect dialog to view (models, lifecycle)
    ...
    onMaintainStrategyPress : function() {
      ...
      if (!this._strategyEditDialog) {
        // create dialog via fragment factory
        this._strategyEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.StrategyEditDialog", this);
        // connect dialog to view (models, lifecycle)
    ...
    onMaintainRacingPress : function() {
      ...
      if (!this._racingEditDialog) {
        // create dialog via fragment factory
        this._racingEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.RacingEditDialog", this);
        // connect dialog to view (models, lifecycle)
    ...
    onMaintainSurvivalPress : function() {
      ...
      if (!this._survivalEditDialog) {
        // create dialog via fragment factory
        this._survivalEditDialog = sap.ui.xmlfragment("lan.party.tournament.fragments.SurvivalEditDialog", this);
        // connect dialog to view (models, lifecycle)
